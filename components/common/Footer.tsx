                    ...
                    <div className="flex gap-4">
                        <div className="h-[45px] w-[45px] bg-white rounded-full flex items-center justify-center">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M14.7498 4.50004H18.4995V0H14.7498C11.8553 0 9.50034 2.355 9.50034 5.24948V7.49948H6.5V12H9.49944V24H13.9999V12H17.7497L18.4995 7.49951H13.9999V5.24948C13.9999 4.84286 14.3432 4.49963 14.7498 4.49963V4.50008L14.7498 4.50004Z" fill="#00C4F4" />
                            </svg>
                        </div>
